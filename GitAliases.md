...
[alias]
    ...
    check = !"git add -p; white='\\e[0;97m';blue='\\e[0;94m';reset='\\e[0m'; IFS=\"\n\"; for line in $(git ls-files -o --exclude-standard); do echo -e -n \"${white}${line}${reset}\n${blue}Stage this file [y,n,q]? ${reset}\"; read doadd; if [ $doadd = \"y\" ]\nthen git add \"${line}\"; elif [ $doadd = \"q\" ]\nthen break; fi done; echo ---------------; git status"
```
